...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    private void initslaveDataSources(Environment env) {
        // 读取配置文件获取更多数据源
        String dsPrefixs = env.getProperty("slave.datasource.names")!=null?env.getProperty("slave.datasource.names").toString():"";
    ...
    public DataSource buildDataSource(Map<String, Object> dataSourceMap) {
        try {
            ...
            String driverClassName = dataSourceMap.get("driver")!=null? dataSourceMap.get("driver").toString():"";
            String url = dataSourceMap.get("url")!=null?dataSourceMap.get("url").toString():"";
            String username = dataSourceMap.get("username")!=null?dataSourceMap.get("username").toString():"";
            String password = dataSourceMap.get("password")!=null?dataSourceMap.get("password").toString():"";
            // 自定义DataSource配置
